"""Run the standard braid benchmark catalog on the sl2 fundamental A-type branch."""
...
from src.invariants.eyb_invariant import build_sl2_fundamental_eyb_data
from src.rmatrix.sl2_rmatrix import build_sl2_fundamental_rmatrix


def main() -> None:
    """Evaluate the default benchmark catalog on the P2-type branch."""
